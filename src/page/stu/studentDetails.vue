...
<script>
    ...
    .top-back {text-align: center;font-size: 36px;color: #444;padding:0 20px 20px 20px;background-color: #fff;}
    .top-back .img1{position: absolute;width: 38px;height: 38px;left: 20px;top: 20px}
    .top-back .ts-img{font-size: 76px;color: #2ed184;}
    .num-p{font-size: 30px;color: #444;}
    .num-p span{color: #2ed184;}
    ...
    .title-div{margin: 0 20px;padding:20px 0;border-bottom: 1px solid #e3e2e2;/*no*/font-size: 28px;color: #444;}
