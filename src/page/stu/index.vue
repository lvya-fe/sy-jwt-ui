<template>
  <div class="index">
    <div class="index_top">
      <i class="icon iconfont icon-tongzhi1 ripple" @click="goMsg">
        <span class="notice-num" v-if="whole.messageCount>0">{{ whole.messageCount>99?'•••':whole.messageCount }}</span>
      </i>
      <br>
...
<style>
  ...
  .vux-x-dialog .weui-dialog__title {
    font-size: 28px;
    color: #444;
  }

  .vux-x-dialog .weui-dialog__ft {
    line-height: 65px;
  }

  .styleA .weui-dialog__ft .weui-dialog__btn_default {
    font-size: 28px;
    color: #fff;
    background-color: #8f8e8e;
  }

  .styleA .weui-dialog__ft .weui-dialog__btn_primary {
    font-size: 28px;
    color: #fff;
