<template>
  <div>
    <div v-show="isshow">
        ...
        <div class="tab-con">
            ...
            <div class="tab-swiper vux-center" v-show="index == 0">
              <!--<scroller :on-refresh="refresh" :on-infinite="infinite"  ref="write">-->
                <group>
    ...
    <showcycle v-show="!isshow" v-bind:conData="taskCycles" v-bind:indexCycle="indexCycle" @closeSelect="closeSelect" @selectCycle="selectCycle"></showcycle>
  </div>
</template>
