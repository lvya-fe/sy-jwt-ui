...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            loadOrg(){
                var _self = this;
                this.$axios.post( process.env.API_ROOT+"app/stu/common/select/selectOrg",
                    qs.stringify({
            ...
            stuIn(org){
                ...
                if(this.stumap[orgid]==undefined){
                    var _self = this;
                    this.$axios.post( process.env.API_ROOT+"app/stu/common/select/selectStu",
                        qs.stringify({
                            uid:_self.$route.params.uid,
                            orgId:orgid,
                            sreach_stu:'',
            ...
            teaIn(org){
                ...
                if(this.teamap[orgid]==undefined){
                    var _self = this;
                    this.$axios.post( process.env.API_ROOT+"app/stu/common/select/selectTea",
                        qs.stringify({
                            uid:_self.$route.params.uid,
                            orgId:orgid,
                            sreach_tea:'',
